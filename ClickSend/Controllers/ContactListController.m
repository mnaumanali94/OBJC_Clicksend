...
- (void) getContactListsWithCompletionBlock:(CompletedGetContactLists) onCompleted
{
    ...
    [_queryBuilder appendString: @"/lists"];
                ...
                completionBlock:(CompletedPostCreateContactList) onCompleted
{
    ...
    if (listName == nil)
        _validationError = [[APIError alloc] initWithReason: @"The parameter 'listName' is a required parameter and cannot be nil."
                                                    andCode: -1
                                                    andData: nil];
                ...
                completionBlock:(CompletedGetContactList) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/lists/{list_id}"];
                ...
                completionBlock:(CompletedPutRemoveDuplicateContacts) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/lists/{list_id}/remove-duplicates"];
                ...
                completionBlock:(CompletedPostImportContactsToList) onCompleted
{
    ...
    //prepare query string for API call
    NSMutableString* _queryBuilder = [NSMutableString stringWithString: _baseUri]; 
    [_queryBuilder appendString: @"/lists/{list_id}/import"];
